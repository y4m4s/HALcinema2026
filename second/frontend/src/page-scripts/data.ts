...
// 上映日は YYYY-MM-DD で保持する。表示ラベルは formatDateLabel() で組み立て、
// 予約APIにもこの値をそのまま渡して上映回を特定する。
export const DATES = ["2026-05-12", "2026-05-13", "2026-05-14", "2026-05-15", "2026-05-16", "2026-05-17", "2026-05-18"];

// モックの「今日」。DATES の先頭 = 当日で、そこから7日分を上映週とする。
// TODAY バッジと、各ページの既定日の判定に使う。
// 呪いのサービスデー (毎月13日) を上映週に含めるため、週は12日始まりにしている。
export const TODAY_DATE = "2026-05-12";
