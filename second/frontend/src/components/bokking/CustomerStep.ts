          ...
          <div class="customer-form-row">
            ...
            <div class="customer-control">
              <div class="customer-tel-group">
                <input type="tel" inputmode="numeric" value="${escapeAttr(state.customer.tel)}" data-customer-field="tel" placeholder="例）09012345678（ハイフンなし）" maxlength="15">
              </div>
              <p class="customer-field-note">ハイフンなしで入力してください</p>
              <p class="customer-field-error" data-customer-error="tel">${errors.tel ? escapeHtml(errors.tel) : ''}</p>
            </div>
          </div>
